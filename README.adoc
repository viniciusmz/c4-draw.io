...
5.  Click on the Custom buttom: kbd:[Custom]
6.  Put in the field kbd:[Enter Value (URL):] the link to the plugin: kbd:[https://tobiashochguertel.github.io/c4-draw.io/c4.js]
7.  Click on kbd:[Apply]
8.  _Reload the page!_ to see the C4 Notation Shapes in the shape panel (_figure 1_).
